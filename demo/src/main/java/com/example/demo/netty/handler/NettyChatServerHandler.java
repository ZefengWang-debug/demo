...
public class NettyChatServerHandler extends SimpleChannelInboundHandler<NettyChatMessage> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, NettyChatMessage msg) {
        if ("CHAT".equalsIgnoreCase(msg.getType())) {
            ...
            ack.setType("ACK"); ack.setSessionId(msg.getSessionId()); ack.setSenderId(msg.getSenderId()); ack.setSenderType("SERVER"); ack.setContent("message saved");
